' CDR Etiketten - Start mit Browser
' Startet die App und oeffnet den Browser. Prueft zuerst ob sie schon laeuft.

Dim WshShell, fso, http, appPort, appUrl, healthUrl, maxRetries, i
...
' Pruefe auch Standard-Port 5000 falls Port-Datei veraltet
...
' --- 5. Warten bis App bereit ist, dann Browser oeffnen ---
For i = 1 To maxRetries
    ...
    If appPort <> "" Then
        ...
        If IsAppRunning(healthUrl) Then
            WshShell.Run "cmd /c start """" http://localhost:" & appPort, 0, False
            WScript.Quit 0
        End If
    End If
Next
